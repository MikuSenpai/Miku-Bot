...
🌸 *${Object.entries(global.db.data.users).filter(user => user[1].banned).length}* Pengguna Terbanned
          ...
          "sections": [
                            {
                                "rows": [{
                                         "title": "📊 › 𐐪-〚 Status 〛-𐑂",
                                         "description": "Status 赤 MIKU  - BOT",
                                         "rowId": ".botstat"
                                    }, {
                                         "title": "⚡› 𐐪-〚 Speed 〛-𐑂",
                                         "description": "Menampilkan Kecepatan Respon 赤 MIKU - BOT",
                                         "rowId": ".ping"
                                    }, {
                                         "title": "🗒️› 𐐪-〚 Info 〛-𐑂",
                                         "description": "Menampilkan Info 赤 MIKU - BOT",
                                         "rowId": ".info"
                                    }, {
                                         "title": "🎐 › 𐐪-〚 Creator 〛-𐑂",
                  ...
                  "description": "Memberikan Semua Fitur 赤 MIKU  - BOT",
                  "rowId": ".? all"
                }, {
                  "title": "🎮 〉ɞ 『 Game 』",
                  ...
                  "rowId": ".? owner"
                                ...
                                "title": "🔬  ∫ » Script «",
                                "description": "Script Yang Di Pakai 赤 MIKU - BOT",
                                "rowId": ".sc"
                                }, {
                                ...
                                "title": "🎖️ ∫  » Thanks To «",
                                "description": "Terima kasih banyak untuk user yang telah berpartisipasi dalam 赤 MIKU  - BOT",
                                "rowId": ".? thnks"
                                }, {
    ...
    // await conn.send3ButtonLoc(m.chat, await (await fetch(fla + teks)).buffer(), text.trim(), '🎮 MIKU BOT', 'Creator', '.creator', 'Donasi', '.donasi', 'Rules', '.infobot', m)
